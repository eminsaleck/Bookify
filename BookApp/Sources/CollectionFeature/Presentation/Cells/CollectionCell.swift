...
public class CollectionCell: UITableViewCell {
  ...
  public func setModel(viewModel: CollectionCellViewModel) {
      posterImageView.setImage(viewModel.image)
    nameLabel.text = viewModel.title
      startYearLabel.text = viewModel.publisher
      averageLabel.text = String(viewModel.rank)
  }
}
